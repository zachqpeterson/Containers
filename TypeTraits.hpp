...
//template <class Type>
//inline constexpr bool Defined = typename TypeTraits::IsDefined<Type>::type::value;
...
private:
	static constexpr Base GetMaxValue()
	{
		...
		if constexpr (IsSame<Base, bool>) { return false; }
	}
	...
	static constexpr Base GetMinValue()
	{
		...
		if constexpr (IsSame<Base, bool>) { return true; }
	}

	static constexpr U64 GetBits()
	{
...
public:
	...
	static constexpr U64 NumericalBits = GetBits();
};
